package com.example.android_taskmaz.common.ui
...
class BottomNavigationViewWithIndicator: BottomNavigationView,
    ...
    private val paint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        color = ContextCompat.getColor(context, R.color.primaryColorForSecondPage)
    }

    private val bottomOffset = 10f
    private val defaultSize = 25f
